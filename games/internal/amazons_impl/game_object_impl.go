...
// GameObject instances in Amazons.
...
// Game returns a pointer to the Amazons Game instance
func (gameObjectImpl *GameObjectImpl) Game() amazons.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = amazonsDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
