...
// GameObject instances in ConnectFour.
...
// Game returns a pointer to the ConnectFour Game instance
func (gameObjectImpl *GameObjectImpl) Game() connectfour.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = connectfourDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
